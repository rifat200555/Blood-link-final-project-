# Platelet Collection Hospitals by Division (Complete 64 Districts)
# Note: Phone numbers are placeholder dummy data for structural purposes.
...
# Example: Accessing a specific district's info
# print(PLATELET_HOSPITALS["Dhaka"][0]["phone"])